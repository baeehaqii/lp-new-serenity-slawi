    ...
    const testimonials: Testimonial[] = [
        {
            id: 1,
            name: "Ayu Diani",
            location: "Slawi, Indonesia",
            image: "https://res.cloudinary.com/dx8w9qwl6/image/upload/v1762656135/download_cszbzm.png",
            rating: 5,
            text: "Lokasinya bener-bener strategis ternyata, deket ke alun-alun Slawi deket kemana-mana.",
        },
        {
            id: 2,
            name: "Shalahudin",
            ...
            image: "https://res.cloudinary.com/dx8w9qwl6/image/upload/v1762656135/download_cszbzm.png",
            rating: 5,
            text: "Kawasan eksklusif dekat pusat pemerintahan dan alun-alun. Hanggawana salah satu impian punya rumah 2 lantai anak dan istri suka modelnya.",
        },
